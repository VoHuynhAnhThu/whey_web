            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <input type="text" name="settings[about_title]" class="form-control"
                        value="<?= htmlspecialchars($about['about_title'] ?? '') ?>"
                        placeholder="Ví dụ: Welcome to FitWhey">
                </div>

                <div class="form-group">
                    <label>Nội dung chi tiết</label>
                    <textarea name="settings[about_content]" class="form-control" rows="8"
                        placeholder="Viết câu chuyện về thương hiệu..."><?= htmlspecialchars($about['about_content'] ?? '') ?></textarea>
                </div>
            </div>
                    ...
                    <?php if (!empty($about['about_image'])): ?>
                        <div class="image-preview-container">
                            ...
                            <div class="image-box">
                                ...
                                ?>
                                <img src="<?= $image_path ?>" alt="About Image"
                                    onerror="this.src='/whey_web/assets/images/default-placeholder.png';">
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
