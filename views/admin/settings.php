...
<div class="container-fluid py-4">
    ...
    <div class="admin-card">
        <form action="/whey_web/admin/update-settings" method="POST" enctype="multipart/form-data">
            <h5 class="fw-bold mb-4" style="border-left: 5px solid #10B981; padding-left: 15px;">Cấu Hình Thông Tin Website</h5>
            ...
            <div class="mb-4">
                ...
                <textarea name="site_description" class="fit-input" rows="4"><?= htmlspecialchars($settings['site_description'] ?? '') ?></textarea>
            </div>
            <div class="row align-items-center mb-5 mt-4">
    <div class="col-md-4 text-center">
        <label class="form-label d-block mb-2">Logo website hiện tại</label>
        <div style="background: #f8f9fa; padding: 15px; border-radius: 15px; border: 2px dashed #ddd; display: inline-block;">
            <?php if (!empty($settings['site_logo'])): ?>
                <img src="/whey_web/public/uploads/<?= $settings['site_logo'] ?>" alt="Logo" style="max-height: 60px;">
            <?php else: ?>
    ...
    <div class="col-md-8">
        ...
        <input type="file" name="site_logo" class="form-control mt-2" style="border-radius: 12px; padding: 10px;">
